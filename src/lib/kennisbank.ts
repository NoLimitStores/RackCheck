...
export const artikelen: Artikel[] = [
  ...
  },
  {
    ...
    related: ["hoe-vaak-stellingen-keuren", "nen-en-15635", "wie-mag-stellingen-inspecteren", "stellingkeuringsrapport-bewaren", "kosten-stellinginspectie", "arbeidsinspectie-magazijn"],
  },
  {
  ...
  },
  {
    ...
    related: ["hoe-vaak-stellingen-keuren", "interne-controle-vs-externe-inspectie", "nen-en-15635", "arbeidsinspectie-magazijn"],
  },
  {
  ...
  },
  {
    ...
    related: ["kosten-stellinginspectie", "checklist-veilige-magazijnstelling", "informatie-in-inspectierapport", "arbeidsinspectie-magazijn"],
  },
  {
  ...
  },
  {
    ...
    related: ["informatie-in-inspectierapport", "hoe-vaak-stellingen-keuren", "is-stellingkeuring-verplicht", "arbeidsinspectie-magazijn"],
  },
  {
    slug: "arbeidsinspectie-magazijn",
    category: "Normen en regels",
    title: "Wat controleert de Nederlandse Arbeidsinspectie in een magazijn?",
    h1: "Wat controleert de Nederlandse Arbeidsinspectie in een magazijn?",
    metaTitle: "Arbeidsinspectie in het magazijn: wat wordt gecontroleerd?",
    metaDescription:
      "Wat kijkt de Nederlandse Arbeidsinspectie na in een magazijn met stellingen? Lees welke regels gelden, welke documenten u toont en hoe handhaving werkt.",
    excerpt:
      "Welke regels de Arbeidsinspectie in een magazijn toetst, wat dat betekent voor uw stellingen en welke documenten u paraat moet hebben.",
    answer:
      "De Nederlandse Arbeidsinspectie toetst of u als werkgever voldoet aan de Arbowet en het Arbobesluit. In een magazijn gaat het dan onder meer om een actuele RI&E met plan van aanpak, veilige arbeidsmiddelen, de keuring van die arbeidsmiddelen met schriftelijk bewijs op de arbeidsplaats, en de risico's van intern transport. Voor stellingen betekent dat: u moet kunnen laten zien dat ze veilig zijn, periodiek worden gekeurd en dat gevonden gebreken worden opgelost. Controles zijn in de regel onaangekondigd.",
    updated: "2026-09-25",
    image: {
      src: "/images/praktijk/palletstelling-onderdoorgang.jpg",
      alt: "Palletstelling met onderdoorgang en gele aanrijdbeveiliging op de staanders in een magazijn",
      caption: "Stellingen, aanrijdbeveiliging en looproutes: zichtbare onderdelen van de arbeidsomstandigheden in een magazijn.",
    },
    blocks: [
      { t: "p", text: "Een bezoek van de Nederlandse Arbeidsinspectie komt vaak onverwacht. Wie weet waar de inspectie op toetst, kan dat bezoek rustig tegemoet zien. Dit artikel legt uit welke regels in een magazijn met stellingen een rol spelen en hoe u aantoont dat u die op orde heeft." },
      { t: "h2", text: "Waar toetst de Arbeidsinspectie op?" },
      { t: "p", text: "De Arbeidsinspectie is de toezichthouder op de arbeidsomstandighedenwetgeving. Een inspecteur toetst dus aan de wet: de Arbowet, het Arbobesluit en de Arboregeling. Normen zoals NEN-EN 15635 zijn geen wet, maar zijn wel een erkende manier om te laten zien hoe u de wettelijke eisen voor stellingen invult." },
      { t: "p", text: "Er is geen openbare, vaste checklist van de Arbeidsinspectie die specifiek over magazijnstellingen gaat. Wat wel vaststaat, zijn de wettelijke verplichtingen die op een magazijn van toepassing zijn. Daaruit volgt waar een inspecteur naar kan kijken." },
      { t: "table", head: ["Onderwerp", "Wettelijke basis", "Wat dit voor stellingen betekent"], rows: [
        ["Zorgplicht", "Arbowet, artikel 3", "U zorgt voor veilige werkplekken en arbeidsmiddelen, ook als de wet geen concrete norm noemt."],
        ["RI&E en plan van aanpak", "Arbowet, artikel 5", "Risico's van stellingen, aanrijdschade en intern transport horen in uw risico-inventarisatie, met maatregelen."],
        ["Keuring van arbeidsmiddelen", "Arbobesluit, artikel 7.4a", "Keuring na installatie en periodieke keuring waar verslechtering kan optreden, door een deskundige."],
        ["Bewijs van keuring", "Arbobesluit, artikel 7.4a (toelichting Arboportaal)", "Schriftelijk bewijs van de keuring is aanwezig op de arbeidsplaats, digitaal of geprint."],
        ["Melding ernstige ongevallen", "Arbowet, artikel 9", "Een arbeidsongeval met dodelijke afloop, blijvend letsel of ziekenhuisopname meldt u direct bij de Arbeidsinspectie."],
      ] },
      { t: "h2", text: "Wat kan een inspecteur bij stellingen vragen of bekijken?" },
      { t: "p", text: "Op basis van de verplichtingen hierboven kunt u verwachten dat een inspecteur vragen stelt over de staat van de stellingen en over de manier waarop u die bewaakt. Denk aan de volgende punten." },
      { t: "ul", items: [
        "Zichtbare schade: vervormde staanders, verbogen liggers, beschadigde schoren of een scheefstaande sectie.",
        "Belasting: is duidelijk hoeveel een stelling mag dragen, bijvoorbeeld via een belastingbord, en wordt dat nageleefd?",
        "Keuring: is er een recent keuringsrapport en kunt u dat op de locatie tonen?",
        "Opvolging: zijn de gebreken uit het vorige rapport aantoonbaar hersteld?",
        "RI&E: staan de risico's van stellingen en intern transport erin, met concrete maatregelen?",
        "Intern transport: zijn looproutes en heftruckroutes gescheiden of anderszins beveiligd, en is aanrijdbeveiliging aanwezig waar dat nodig is?",
      ] },
      { t: "note", text: "Dit is geen officiele inspectielijst, maar een afleiding uit de regels die op magazijnen van toepassing zijn. De inspecteur bepaalt zelf waar het bezoek zich op richt." },
      { t: "h2", text: "Waarom intern transport extra aandacht krijgt" },
      { t: "p", text: "Heftrucks en stellingen zijn in een magazijn nauw met elkaar verbonden: veel stellingschade ontstaat door aanrijdingen. De Arbeidsinspectie publiceerde in september 2026 dat zij in de periode 2020 tot en met 2025 309 arbeidsongevallen onderzocht waarbij een heftruck of vergelijkbaar intern transportmiddel iemand aanreed. Tien slachtoffers overleden. Volgens de inspectie lag de oorzaak meestal niet in een technisch mankement, maar in het feit dat bestuurder en slachtoffer elkaar niet op tijd opmerkten. Dat onderstreept het belang van overzichtelijke routes, scheiding van voetgangers en heftrucks en een goed onderhouden stellingopstelling." },
      { t: "h2", text: "Hoe verloopt een controle?" },
      { t: "p", text: "Volgens de Arbeidsinspectie zijn controles in de regel onaangekondigd. In sommige gevallen wordt een bezoek wel aangekondigd, bijvoorbeeld als bepaalde specialisten aanwezig moeten zijn. De inspectie werkt risicogericht: naast meldingen en klachten voert zij controles uit waarvan de frequentie afhangt van het risico in een sector. Na een meldingsplichtig ongeval volgt doorgaans een ongevalsonderzoek." },
      { t: "h2", text: "Wat gebeurt er bij een overtreding?" },
      { t: "p", text: "De Arbeidsinspectie gebruikt verschillende handhavingsinstrumenten. Welke wordt ingezet, hangt af van de ernst van de overtreding en van eerdere overtredingen." },
      { t: "table", head: ["Instrument", "Wanneer (volgens de Arbeidsinspectie)"], rows: [
        ["Waarschuwing", "Bij overtreding van een concrete norm in de wet; u krijgt een termijn om het op te lossen."],
        ["Eis", "Bij overtreding van een doelvoorschrift, zoals de plicht om werk veilig te organiseren; de inspecteur schrijft voor welke maatregelen nodig zijn en binnen welke termijn."],
        ["Boete", "Als een waarschuwing of eis niet is opgevolgd, bij ernstige overtredingen en bij herhaling. Voor bepaalde overtredingen, zoals het ontbreken van een schriftelijke RI&E met plan van aanpak, volgt direct een boete."],
        ["Stillegging", "Bij ernstig gevaar voor de veiligheid of gezondheid kan de inspecteur het werk of een deel ervan direct stilleggen."],
        ["Preventieve stillegging", "Bij herhaalde overtredingen, na een voorafgaande waarschuwing."],
      ] },
      { t: "note", text: "Boetebedragen staan in de beleidsregels van de Arbeidsinspectie en hangen af van de overtreding en de omvang van het bedrijf. Wij noemen hier bewust geen bedragen." },
      { t: "h2", text: "Welke documenten heeft u paraat?" },
      { t: "ol", items: [
        "Uw actuele RI&E met plan van aanpak, waarin stellingen en intern transport zijn meegenomen.",
        "Het meest recente keuringsrapport van de stellingen, op de locatie te tonen.",
        "Vastlegging van herstel van eerdere bevindingen, met datum en uitvoerder.",
        "Een logboek van interne controles, bijvoorbeeld bijgehouden door de PRSES.",
        "Belastinggegevens van de stellingen, zoals het belastingbord of de gegevens van de leverancier.",
      ] },
      { t: "h2", text: "Hoe RackCheck u helpt" },
      { t: "p", text: "RackCheck inspecteert uw magazijnstellingen onafhankelijk en legt de bevindingen vast in een rapport met foto's, classificatie en vervolgacties. Daarmee heeft u het schriftelijk bewijs van keuring direct beschikbaar en kunt u aantonen welke gebreken er waren en hoe u die heeft opgevolgd. Wij beoordelen uw stellingen; de toetsing aan de wet blijft de rol van de Arbeidsinspectie." },
    ],
    faq: [
      { q: "Komt de Arbeidsinspectie altijd onaangekondigd?", a: "Volgens de Arbeidsinspectie zijn controles in de regel onaangekondigd. In sommige gevallen kondigt de inspectie een bezoek wel aan, bijvoorbeeld als specialisten aanwezig moeten zijn." },
      { q: "Toetst de Arbeidsinspectie aan NEN-EN 15635?", a: "De inspectie toetst aan de wet, zoals de Arbowet en het Arbobesluit. NEN-EN 15635 is een norm en geen wet, maar is wel een erkende manier om aan te tonen hoe u de wettelijke zorgplicht en keuringsplicht voor stellingen invult." },
      { q: "Krijg ik direct een boete als er stellingschade is?", a: "Niet per se. Bij veel overtredingen begint de inspectie met een waarschuwing of eis met een hersteltermijn. Bij ernstig gevaar kan het werk worden stilgelegd, en voor bepaalde overtredingen, zoals het ontbreken van een schriftelijke RI&E, volgt direct een boete." },
      { q: "Moet ik een omgevallen of ingestorte stelling melden?", a: "Een arbeidsongeval met dodelijke afloop, blijvend letsel of ziekenhuisopname moet u direct melden bij de Arbeidsinspectie. Is er niemand gewond geraakt, dan geldt die meldplicht niet, maar laat de stellingen dan wel direct beoordelen." },
    ],
    related: ["is-stellingkeuring-verplicht", "stellingkeuringsrapport-bewaren", "magazijn-voorbereiden-op-inspectie"],
  },
];
